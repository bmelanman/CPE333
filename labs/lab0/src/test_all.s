...
%define test        ( 0x0044 )
%define SWITCHES    ( 0x11000000 )
%define VGA_READ    ( 0x11040000 )
%define LEDS        ( 0x11080000 )
%define SSEG        ( 0x110C0000 )
%define VGA_ADDR    ( 0x11100000 )
%define VGA_COLOR   ( 0x11140000 )
...
main:
	...
	li x12, LEDS
loop:
	li  x14, -1;         call post_test  # Test | # of Tests |
	jal x31, add_test;   call post_test  # 0x00 |         17 |
	jal x31, sub_test;   call post_test	 # 0x01 |         16 |
	jal x31, and_test;   call post_test	 # 0x02 |          7 |
	jal x31, or_test;    call post_test	 # 0x03 |          7 |
	jal x31, xor_test;   call post_test	 # 0x04 |          7 |
	jal x31, sll_test;   call post_test	 # 0x05 |         19 |
	jal x31, srl_test;   call post_test	 # 0x06 |         17 |
	jal x31, sra_test;   call post_test	 # 0x07 |         20 |
	jal x31, slt_test;   call post_test	 # 0x08 |         16 |
	jal x31, sltu_test;  call post_test	 # 0x09 |         16 |
	jal x31, addi_test;  call post_test	 # 0x0A |         16 |
	jal x31, andi_test;  call post_test	 # 0x0B |          5 |
	jal x31, ori_test;   call post_test	 # 0x0C |          5 |
	jal x31, xori_test;  call post_test	 # 0x0D |          5 |
	jal x31, slli_test;  call post_test	 # 0x0E |         15 |
	jal x31, srli_test;  call post_test	 # 0x0F |         16 |
	jal x31, srai_test;  call post_test	 # 0x10 |         16 |
	jal x31, sltiu_test; call post_test	 # 0x11 |         16 |
	jal x31, slti_test;  call post_test	 # 0x12 |         16 |
	jal x31, lw_test;    call post_test	 # 0x13 |          9 |
	jal x31, sw_test;    call post_test	 # 0x14 |          9 |
	jal x31, beq_test;   call post_test	 # 0x15 |          7 |
	jal x31, bne_test;   call post_test	 # 0x16 |          7 |
	jal x31, blt_test;   call post_test	 # 0x17 |          7 |
	jal x31, bge_test;   call post_test	 # 0x18 |         10 |
	jal x31, bltu_test;  call post_test	 # 0x19 |          7 |
	jal x31, bgeu_test;  call post_test	 # 0x1A |         10 |
	jal x31, auipc_test; call post_test	 # 0x1B |          2 |
	jal x31, lui_test;   call post_test	 # 0x1C |          5 |
	jal x31, jal_test;   call post_test	 # 0x1D |          2 |
	jal x31, jalr_test;  call post_test	 # 0x1E |          4 |
	jal x31, lh_test;    call post_test	 # 0x1F |         10 |
	jal x31, lb_test;    call post_test	 # 0x20 |         10 |
	jal x31, lhu_test;   call post_test	 # 0x21 |         10 |
	jal x31, lbu_test;   call post_test	 # 0x22 |         10 |
	jal x31, sh_test;    call post_test	 # 0x23 |         10 |
	jal x31, sb_test;    call post_test	 # 0x24 |         10 |
